...
JOIN : https://t.me/TGBotsCollection \n For the List of Telegram Bots"""
    ...
    FF_MPEG_RO_BOT_STOR_AGE_ALREADY_EXISTS = "A media is already present. \n\nDo you want to delete that??" # A saved media already exists. Please send /storageinfo to know the current media details.    USER_DELETED_FROM_DB = "User <a href='tg://user?id={}'>{}</a> deleted from DataBase."
